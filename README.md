...
| **GitHub&nbsp;Actions** |  |
|:-----------------------------|:-|
| Badge | [![MATLAB](https://github.com/idlcm/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https://github.com/idlcm/ci-configuration-examples/actions/workflows/ci.yml) |
| Badge Code | \[\!\[MATLAB](https[]()://github.com/idlcm/ci-configuration-examples/actions/workflows/ci.yml/badge.svg)](https[]()://github.com/idlcm/ci-configuration-examples/actions/workflows/ci.yml) |
